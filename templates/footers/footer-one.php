<footer class="bg-white border-t-2" aria-labelledby="footer-heading">
    <h2 id="footer-heading" class="sr-only"><?php echo __('Footer', 'wpstorm-theme') ?></h2>
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-12 sm:pt-24 lg:px-8 lg:pt-24">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-8">
                <img class="h-7" src="<?php echo esc_url(get_site_icon_url()) ?>"
                     alt="Company name">
                <p class="text-sm leading-6 text-gray-600"><?php echo get_theme_mod('footer_company_description', 'Making the world a better place through constructing elegant hierarchies.') ?></p>
            </div>
            <div class="mt-16 grid gap-8 xl:col-span-2 xl:mt-0">
                <div class="md:grid md:grid-cols-4 md:gap-8">
                    <?php
                    // Define the footer menu locations
                    ...
                    foreach ($footer_menu_locations as $index => $location) :
                        ...
                        if (!empty($menu_items)) :
                            ...
                            <div class="mt-10 md:mt-0">
                                <h3 class="text-sm font-semibold leading-6 text-gray-900"><?php echo esc_html($menu_name); ?></h3>
        ...
        <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
            <div>
                <h3 class="text-sm font-semibold leading-6 text-gray-900"><?php echo get_theme_mod('footer_newsletter_title', 'Subscribe to our newsletter') ?></h3>
                <p class="mt-2 text-sm leading-6 text-gray-600"><?php echo get_theme_mod('footer_newsletter_sub_title', 'The latest news, articles, and resources, sent to your inbox weekly.') ?></p>
            </div>
