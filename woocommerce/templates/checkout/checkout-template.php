    ...
    <main class="mx-auto max-w-7xl px-4 pb-24 pt-16 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:max-w-5xl">
            ...
            <form class="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
                ...
                <!-- Order summary -->
                <div class="mt-10 lg:mt-0 sticky top-10 self-start">
                    <h2 class="text-lg font-medium text-gray-900"><?php echo __('Order summary', 'wpstorm-theme')?></h2>

                    <div class="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
                        <h3 class="sr-only"><?php echo __('Items in your cart', 'wpstorm-theme')?></h3>
