...
<div x-data="profilePage" class="mx-auto max-w-7xl lg:flex lg:gap-x-16 lg:px-8">
  ...
  <main class="px-4 py-16 sm:px-6 lg:flex-auto lg:px-0 lg:py-20">
    <div x-show="section === 'general'" x-cloak x-transition.opacity.duration.300ms class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
      <?php require_once 'profile-one-general-section.php'; ?>
    </div>

    <div x-show="section === 'security'" x-cloak x-transition.opacity.duration.300ms class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
      <?php require_once 'profile-one-security-section.php'; ?>
    </div>

    <div x-show="section === 'posts' || section === 'create-post' || section === 'edit-post'" x-cloak x-transition.opacity.duration.300ms class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
